...
curl -o $INSTALL_DIR/chef_installer/cookbooks/installer/recipes/installer.rb https://raw.githubusercontent.com/CSGOpenSource/chef-services/csg_master/files/default/installer.rb
